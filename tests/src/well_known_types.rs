...
fn test_well_known_types() {
    let msg = Foo {
        null: ::defiant_types::NullValue::NullValue.into(),
        timestamp: Some(::defiant_types::Timestamp {
            seconds: 99,
            nanos: 42,
        }),
...
fn test_timestamp() {
    ...
    let timestamp = ::defiant_types::Timestamp {
        seconds: 100,
        nanos: 42,
    };

    let mut non_normalized_timestamp = ::defiant_types::Timestamp {
        seconds: 99,
        nanos: 1_000_000_042,
    };
