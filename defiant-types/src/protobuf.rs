...
pub struct FileDescriptorSet<'arena> {
    ...
    pub file: &'arena [&'arena FileDescriptorProto<'arena>],
}
...
pub struct FileDescriptorProto<'arena> {
    ...
    #[defiant(string, optional, tag = "1")]
    pub name: ::core::option::Option<&'arena str>,
    /// e.g. "foo", "foo.bar", etc.
    #[defiant(string, optional, tag = "2")]
    pub package: ::core::option::Option<&'arena str>,
    /// Names of files imported by this file.
    #[defiant(string, repeated, tag = "3")]
    pub dependency: &'arena [&'arena str],
    /// Indexes of the public imported files in the dependency list above.
    #[defiant(int32, repeated, packed = "false", tag = "10")]
    pub public_dependency: &'arena [i32],
    /// Indexes of the weak imported files in the dependency list.
    /// For Google-internal migration only. Do not use.
    #[defiant(int32, repeated, packed = "false", tag = "11")]
    pub weak_dependency: &'arena [i32],
    /// All top-level definitions in this file.
    #[defiant(message, repeated, tag = "4")]
    pub message_type: &'arena [&'arena DescriptorProto<'arena>],
    #[defiant(message, repeated, tag = "5")]
    pub enum_type: &'arena [&'arena EnumDescriptorProto<'arena>],
    #[defiant(message, repeated, tag = "6")]
    pub service: &'arena [&'arena ServiceDescriptorProto<'arena>],
    #[defiant(message, repeated, tag = "7")]
    pub extension: &'arena [&'arena FieldDescriptorProto<'arena>],
    #[defiant(message, optional, tag = "8")]
    pub options: ::core::option::Option<&'arena FileOptions<'arena>>,
    /// This field contains optional information about the original source code.
    /// You may safely remove this entire field without harming runtime
    /// functionality of the descriptors -- the information is needed only by
    /// development tools.
    #[defiant(message, optional, tag = "9")]
    pub source_code_info: ::core::option::Option<&'arena SourceCodeInfo<'arena>>,
    /// The syntax of the proto file.
    /// The supported values are "proto2" and "proto3".
    #[defiant(string, optional, tag = "12")]
    pub syntax: ::core::option::Option<&'arena str>,
}
...
pub struct DescriptorProto<'arena> {
    ...
    pub field: &'arena [&'arena FieldDescriptorProto<'arena>],
    #[defiant(message, repeated, tag = "6")]
    pub extension: &'arena [&'arena FieldDescriptorProto<'arena>],
    #[defiant(message, repeated, tag = "3")]
    pub nested_type: &'arena [&'arena DescriptorProto<'arena>],
    #[defiant(message, repeated, tag = "4")]
    pub enum_type: &'arena [&'arena EnumDescriptorProto<'arena>],
    #[defiant(message, repeated, tag = "5")]
    pub extension_range: &'arena [&'arena descriptor_proto::ExtensionRange<'arena>],
    #[defiant(message, repeated, tag = "8")]
    pub oneof_decl: &'arena [&'arena OneofDescriptorProto<'arena>],
    #[defiant(message, optional, tag = "7")]
    pub options: ::core::option::Option<&'arena MessageOptions<'arena>>,
    #[defiant(message, repeated, tag = "9")]
    pub reserved_range: &'arena [descriptor_proto::ReservedRange],
    /// Reserved field names, which may not be used by fields in the same message.
    /// A given name may only be reserved once.
    #[defiant(string, repeated, tag = "10")]
    pub reserved_name: &'arena [&'arena str],
}
...
pub struct ExtensionRangeOptions<'arena> {
    ...
    #[defiant(message, repeated, tag = "999")]
    pub uninterpreted_option: &'arena [&'arena UninterpretedOption<'arena>],
}
...
pub struct FieldDescriptorProto<'arena> {
    #[defiant(string, optional, tag = "1")]
    pub name: ::core::option::Option<&'arena str>,
    #[defiant(int32, optional, tag = "3")]
    pub number: ::core::option::Option<i32>,
    #[defiant(enumeration = "field_descriptor_proto::Label", optional, tag = "4")]
    pub label: ::core::option::Option<i32>,
    /// If type_name is set, this need not be set.  If both this and type_name
    /// are set, this must be one of TYPE_ENUM, TYPE_MESSAGE or TYPE_GROUP.
    #[defiant(enumeration = "field_descriptor_proto::Type", optional, tag = "5")]
    ...
    /// namespace).
    #[defiant(string, optional, tag = "6")]
    pub type_name: ::core::option::Option<&'arena str>,
    /// For extensions, this is the name of the type being extended.  It is
    /// resolved in the same manner as type_name.
    #[defiant(string, optional, tag = "2")]
    pub extendee: ::core::option::Option<&'arena str>,
    /// For numeric types, contains the original text representation of the value.
    /// For booleans, "true" or "false".
    /// For strings, contains the default text contents (not escaped in any way).
    /// For bytes, contains the C escaped value.  All bytes >= 128 are escaped.
    /// TODO(kenton):  Base-64 encode?
    #[defiant(string, optional, tag = "7")]
    pub default_value: ::core::option::Option<&'arena str>,
    /// If set, gives the index of a oneof in the containing type's oneof_decl
    /// list.  This field is a member of that oneof.
    #[defiant(int32, optional, tag = "9")]
    pub oneof_index: ::core::option::Option<i32>,
    /// JSON name of this field. The value is set by protocol compiler. If the
    /// user has set a "json_name" option on this field, that option's value
    /// will be used. Otherwise, it's deduced from the field's name by converting
    /// it to camelCase.
    #[defiant(string, optional, tag = "10")]
    pub json_name: ::core::option::Option<&'arena str>,
    #[defiant(message, optional, tag = "8")]
...
pub struct OneofDescriptorProto<'arena> {
    #[defiant(string, optional, tag = "1")]
    pub name: ::core::option::Option<&'arena str>,
    #[defiant(message, optional, tag = "2")]
...
pub struct EnumDescriptorProto<'arena> {
    ...
    pub name: ::core::option::Option<&'arena str>,
    #[defiant(message, repeated, tag = "2")]
    pub value: &'arena [&'arena EnumValueDescriptorProto<'arena>],
    #[defiant(message, optional, tag = "3")]
    ...
    /// overlap.
    #[defiant(message, repeated, tag = "4")]
    pub reserved_range: &'arena [enum_descriptor_proto::EnumReservedRange],
    /// Reserved enum value names, which may not be reused. A given name may only
    /// be reserved once.
    #[defiant(string, repeated, tag = "5")]
    pub reserved_name: &'arena [&'arena str],
}
...
pub struct ServiceDescriptorProto<'arena> {
    ...
    pub name: ::core::option::Option<&'arena str>,
    #[defiant(message, repeated, tag = "2")]
    pub method: &'arena [&'arena MethodDescriptorProto<'arena>],
    #[defiant(message, optional, tag = "3")]
...
pub struct MethodDescriptorProto<'arena> {
    ...
    #[defiant(string, optional, tag = "2")]
    pub input_type: ::core::option::Option<&'arena str>,
    #[defiant(string, optional, tag = "3")]
    pub output_type: ::core::option::Option<&'arena str>,
    #[defiant(message, optional, tag = "4")]
    pub options: ::core::option::Option<&'arena MethodOptions<'arena>>,
    /// Identifies if client streams multiple client messages
    #[defiant(bool, optional, tag = "5", default = "false")]
    pub client_streaming: ::core::option::Option<bool>,
    /// Identifies if server streams multiple server messages
    #[defiant(bool, optional, tag = "6", default = "false")]
...
pub struct FileOptions<'arena> {
    ...
    /// domain names.
    #[defiant(string, optional, tag = "1")]
    pub java_package: ::core::option::Option<&'arena str>,
    /// Controls the name of the wrapper Java class generated for the .proto file.
    /// That class will always contain the .proto file's getDescriptor() method as
    /// well as any top-level extensions defined in the .proto file.
    /// If java_multiple_files is disabled, then all the other classes from the
    /// .proto file will be nested inside the single wrapper outer class.
    #[defiant(string, optional, tag = "8")]
    pub java_outer_classname: ::core::option::Option<&'arena str>,
    ...
    #[defiant(bool, optional, tag = "10", default = "false")]
    pub java_multiple_files: ::core::option::Option<bool>,
    /// This option does nothing.
    #[deprecated]
    #[defiant(bool, optional, tag = "20")]
    ...
    #[defiant(bool, optional, tag = "27", default = "false")]
    pub java_string_check_utf8: ::core::option::Option<bool>,
    #[defiant(enumeration = "file_options::OptimizeMode", optional, tag = "9", default = "Speed")]
    ...
    #[defiant(string, optional, tag = "11")]
    pub go_package: ::core::option::Option<&'arena str>,
    ...
    #[defiant(bool, optional, tag = "16", default = "false")]
    pub cc_generic_services: ::core::option::Option<bool>,
    #[defiant(bool, optional, tag = "17", default = "false")]
    pub java_generic_services: ::core::option::Option<bool>,
    #[defiant(bool, optional, tag = "18", default = "false")]
    pub py_generic_services: ::core::option::Option<bool>,
    #[defiant(bool, optional, tag = "42", default = "false")]
    pub php_generic_services: ::core::option::Option<bool>,
    /// Is this file deprecated?
    /// Depending on the target platform, this can emit Deprecated annotations
    /// for everything in the file, or it will be completely ignored; in the very
    /// least, this is a formalization for deprecating files.
    #[defiant(bool, optional, tag = "23", default = "false")]
    pub deprecated: ::core::option::Option<bool>,
    /// Enables the use of arenas for the proto messages in this file. This applies
    /// only to generated classes for C++.
    #[defiant(bool, optional, tag = "31", default = "true")]
    pub cc_enable_arenas: ::core::option::Option<bool>,
    /// Sets the objective c class prefix which is prepended to all objective c
    /// generated classes from this .proto. There is no default.
    #[defiant(string, optional, tag = "36")]
    pub objc_class_prefix: ::core::option::Option<&'arena str>,
    /// Namespace for generated classes; defaults to the package.
    #[defiant(string, optional, tag = "37")]
    pub csharp_namespace: ::core::option::Option<&'arena str>,
    /// By default Swift generators will take the proto package and CamelCase it
    /// replacing '.' with underscore and use that to prefix the types/symbols
    /// defined. When this options is provided, they will use this value instead
    /// to prefix the types/symbols defined.
    #[defiant(string, optional, tag = "39")]
    pub swift_prefix: ::core::option::Option<&'arena str>,
    /// Sets the php class prefix which is prepended to all php generated classes
    /// from this .proto. Default is empty.
    #[defiant(string, optional, tag = "40")]
    pub php_class_prefix: ::core::option::Option<&'arena str>,
    /// Use this option to change the namespace of php generated classes. Default
    /// is empty. When this option is empty, the package name will be used for
    /// determining the namespace.
    #[defiant(string, optional, tag = "41")]
    pub php_namespace: ::core::option::Option<&'arena str>,
    /// Use this option to change the namespace of php generated metadata classes.
    /// Default is empty. When this option is empty, the proto file name will be
    /// used for determining the namespace.
    #[defiant(string, optional, tag = "44")]
    pub php_metadata_namespace: ::core::option::Option<&'arena str>,
    /// Use this option to change the package of ruby generated classes. Default
    /// is empty. When this option is not set, the package name will be used for
    /// determining the ruby package.
    #[defiant(string, optional, tag = "45")]
    pub ruby_package: ::core::option::Option<&'arena str>,
...
pub struct FieldOptions<'arena> {
    ...
    #[defiant(enumeration = "field_options::CType", optional, tag = "1", default = "String")]
    ...
    /// goog.math.Integer.
    #[defiant(enumeration = "field_options::JsType", optional, tag = "6", default = "JsNormal")]
...
pub struct ServiceOptions<'arena> {
    ...
    #[defiant(bool, optional, tag = "33", default = "false")]
    pub deprecated: ::core::option::Option<bool>,
    /// The parser stores options it doesn't recognize here. See above.
    #[defiant(message, repeated, tag = "999")]
    pub uninterpreted_option: &'arena [&'arena UninterpretedOption<'arena>],
...
pub struct MethodOptions<'arena> {
    ...
    #[defiant(bool, optional, tag = "33", default = "false")]
    pub deprecated: ::core::option::Option<bool>,
    #[defiant(enumeration = "method_options::IdempotencyLevel", optional, tag = "34", default = "IdempotencyUnknown")]
...
pub struct UninterpretedOption<'arena> {
    #[defiant(message, repeated, tag = "2")]
    pub name: &'arena [&'arena uninterpreted_option::NamePart<'arena>],
    /// The value of the uninterpreted option, in whatever type the tokenizer
    /// identified it as during parsing. Exactly one of these should be set.
    #[defiant(string, optional, tag = "3")]
    pub identifier_value: ::core::option::Option<&'arena str>,
    #[defiant(uint64, optional, tag = "4")]
    pub positive_int_value: ::core::option::Option<u64>,
    #[defiant(int64, optional, tag = "5")]
    pub negative_int_value: ::core::option::Option<i64>,
    #[defiant(double, optional, tag = "6")]
    pub double_value: ::core::option::Option<f64>,
    #[defiant(bytes = "vec", optional, tag = "7")]
    pub string_value: ::core::option::Option<&'arena [u8]>,
    #[defiant(string, optional, tag = "8")]
    pub aggregate_value: ::core::option::Option<&'arena str>,
}
...
pub mod uninterpreted_option {
    ...
    pub struct NamePart<'arena> {
        ...
        pub name_part: &'arena str,
        #[defiant(bool, required, tag = "2")]
...
pub struct SourceCodeInfo<'arena> {
    ...
    #[defiant(message, repeated, tag = "1")]
    pub location: &'arena [&'arena source_code_info::Location<'arena>],
}
...
pub mod source_code_info {
    ...
    pub struct Location<'arena> {
        ...
        #[defiant(string, optional, tag = "3")]
        pub leading_comments: ::core::option::Option<&'arena str>,
        #[defiant(string, optional, tag = "4")]
        pub trailing_comments: ::core::option::Option<&'arena str>,
        #[defiant(string, repeated, tag = "6")]
        pub leading_detached_comments: &'arena [&'arena str],
    }
}
...
pub struct GeneratedCodeInfo<'arena> {
    ...
    #[defiant(message, repeated, tag = "1")]
    pub annotation: &'arena [&'arena generated_code_info::Annotation<'arena>],
}
...
pub mod generated_code_info {
    ...
    pub struct Annotation<'arena> {
        ...
        #[defiant(string, optional, tag = "2")]
        pub source_file: ::core::option::Option<&'arena str>,
...
pub struct Any<'arena> {
    ...
    pub type_url: &'arena str,
    /// Must be a valid serialized protocol buffer of the above specified type.
    #[defiant(bytes = "vec", tag = "2")]
    pub value: &'arena [u8],
}
...
pub struct Type<'arena> {
    ...
    /// The list of fields.
    #[defiant(message, repeated, tag = "2")]
    pub fields: &'arena [&'arena Field<'arena>],
    /// The list of types appearing in `oneof` definitions in this type.
    #[defiant(string, repeated, tag = "3")]
    pub oneofs: &'arena [&'arena str],
    /// The protocol buffer options.
    #[defiant(message, repeated, tag = "4")]
    pub options: &'arena [&'arena self::Option<'arena>],
    /// The source context.
    #[defiant(message, optional, tag = "5")]
    pub source_context: ::core::option::Option<&'arena SourceContext<'arena>>,
    /// The source syntax.
    #[defiant(enumeration = "Syntax", tag = "6")]
    pub syntax: i32,
}
...
pub struct Field<'arena> {
    /// The field type.
    #[defiant(enumeration = "field::Kind", tag = "1")]
    pub kind: i32,
    /// The field cardinality.
    #[defiant(enumeration = "field::Cardinality", tag = "2")]
    pub cardinality: i32,
    /// The field number.
    #[defiant(int32, tag = "3")]
    pub number: i32,
    /// The field name.
    #[defiant(string, tag = "4")]
    pub name: &'arena str,
    /// The field type URL, without the scheme, for message or enumeration
    /// types. Example: `"type.googleapis.com/google.protobuf.Timestamp"`.
    #[defiant(string, tag = "6")]
    pub type_url: &'arena str,
    ...
    pub options: &'arena [&'arena self::Option<'arena>],
    /// The field JSON name.
    #[defiant(string, tag = "10")]
    pub json_name: &'arena str,
    /// The string value of the default value of this field. Proto2 syntax only.
    #[defiant(string, tag = "11")]
    pub default_value: &'arena str,
}
...
pub struct Enum<'arena> {
    ...
    #[defiant(message, repeated, tag = "2")]
    pub enumvalue: &'arena [&'arena EnumValue<'arena>],
    ...
    pub source_context: ::core::option::Option<&'arena SourceContext<'arena>>,
    /// The source syntax.
    #[defiant(enumeration = "Syntax", tag = "5")]
    pub syntax: i32,
}
...
pub struct Option<'arena> {
    ...
    #[defiant(message, optional, tag = "2")]
    pub value: ::core::option::Option<&'arena Any<'arena>>,
}
...
pub struct Api<'arena> {
    ...
    #[defiant(message, repeated, tag = "2")]
    pub methods: &'arena [&'arena Method<'arena>],
    ...
    #[defiant(message, repeated, tag = "6")]
    pub mixins: &'arena [&'arena Mixin<'arena>],
    /// The source syntax of the service.
    #[defiant(enumeration = "Syntax", tag = "7")]
    pub syntax: i32,
}
...
pub struct Method<'arena> {
    ...
    pub request_type_url: &'arena str,
    /// If true, the request is streamed.
    #[defiant(bool, tag = "3")]
    pub request_streaming: bool,
    /// The URL of the output message type.
    #[defiant(string, tag = "4")]
    pub response_type_url: &'arena str,
...
pub struct Struct<'arena> {
    ...
    pub fields: ::defiant::ArenaMap<'arena, &'arena str, Value<'arena>>,
}
...
pub mod value {
    ...
    pub enum Kind<'arena> {
        ...
        #[defiant(enumeration = "super::NullValue", tag = "1")]
        NullValue(i32),
...
pub struct ListValue<'arena> {
    ...
    #[defiant(message, repeated, tag = "1")]
    pub values: &'arena [&'arena Value<'arena>],
}
