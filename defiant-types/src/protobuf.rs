// This file is @generated by defiant-build.
...
pub struct DescriptorProto<'arena> {
    ...
    pub reserved_range: &'arena [&'arena descriptor_proto::ReservedRange],
...
pub struct EnumDescriptorProto<'arena> {
    ...
    /// overlap.
    #[defiant(message, repeated, tag = "4")]
    pub reserved_range: &'arena [&'arena enum_descriptor_proto::EnumReservedRange],
...
pub struct UninterpretedOption<'arena> {
    ...
    #[defiant(bytes = "bytes", optional, tag = "7")]
...
pub struct Type<'arena> {
    ...
    #[defiant(message, repeated, tag = "4")]
    pub options: &'arena [&'arena ProtoOption<'arena>],
    /// The source context.
...
impl<'arena> Default for Value<'arena> {
    fn default() -> Self {
        Value { kind: None }
    }
}
...
#[cfg_attr(feature = "arbitrary", derive(arbitrary::Arbitrary))]
#[derive(Clone, PartialEq, Default, defiant::View)]
